...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      pattern = '<%si'%length
      buff.write(struct.pack(pattern, *self.startRingIndex))
      length = len(self.endRingIndex)
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(struct.pack(pattern, *self.endRingIndex))
      _x = self
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sB'%length
      buff.write(struct.pack(pattern, *self.segmentedCloudGroundFlag))
      length = len(self.segmentedCloudColInd)
      buff.write(_struct_I.pack(length))
      pattern = '<%sI'%length
      buff.write(struct.pack(pattern, *self.segmentedCloudColInd))
      length = len(self.segmentedCloudRange)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.pack(pattern, *self.segmentedCloudRange))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.startRingIndex = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%si'%length
      ...
      self.endRingIndex = struct.unpack(pattern, str[start:end])
      _x = self
      start = end
      end += 12
      ...
      self.segmentedCloudGroundFlag = struct.unpack(pattern, str[start:end])
      self.segmentedCloudGroundFlag = map(bool, self.segmentedCloudGroundFlag)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sI'%length
      ...
      self.segmentedCloudColInd = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      self.segmentedCloudRange = struct.unpack(pattern, str[start:end])
      return self
