...
const byte revConKillPin = 30;  // digital out to reversing contactor (LOW for kill, HIGH for unkill)
...
int Q1BitOut = 0;                         // bit output to Q1
int Q2BitOut = 0;                         // bit output to Q2
int Q3BitOut = 0;                         // bit output to Q3
int Q4BitOut = 0;                         // bit output to Q4
...
void loop() {
  ...
  if (mode == 1) {
    ...
    // Write thruster outputs to reversing contactors
    output2RevCon();
  ...
  // Autonomous code
    ...
    Serial.println("AUTONOMOUS MODE ENGAGED...WHICH DOESN'T DO ANYTHING BECUASE REASONS!");
