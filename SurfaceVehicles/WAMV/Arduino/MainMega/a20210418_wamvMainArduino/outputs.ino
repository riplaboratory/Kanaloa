...
void createI2cMsg() {
  ...
  */
  ...
  // Create C-string message to send over I2C
  commandToMsg(leftThrusterSetpoint);   // Q1 will act as rightServoOut
  commandToMsg(rightThrusterSetpoint);  // Q2 will act as leftServoOut
