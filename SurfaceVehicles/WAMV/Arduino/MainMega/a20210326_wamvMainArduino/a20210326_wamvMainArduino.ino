/*
    ...
    Modifications:
      - Since number of channels on remote controller is limited, swapped both battery check
        switches for calibration code and software reset code (required at this time)
