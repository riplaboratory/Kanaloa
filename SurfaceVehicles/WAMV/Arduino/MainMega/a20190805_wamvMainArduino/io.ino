...
//  Serial.println(" ");
  ...
  // ------ SERIAL SPEED COMMANDS -----
//  q1Out = serialSpeedCommand;
//  q2Out = serialSpeedCommand;
//  q3Out = serialSpeedCommand;
//  q4Out = serialSpeedCommand;
//  pwmSpeedCommand = map(serialSpeedCommand,-1000,1000,-4095,4095);
  pwmSpeedCommand = serialSpeedCommand;
  Serial.print("PWM: ");
  Serial.print(pwmSpeedCommand);
  setSpd(pwmSpeedCommand);
  
  // Mapping for Minn Kota 24V RT80 EM thrusters
  int q1ServoOut = map(q1Out,-1000,1000,0,4095);
  int q2ServoOut = map(q2Out,-1000,1000,0,4095);
  int q3ServoOut = map(q3Out,-1000,1000,0,4095);
  int q4ServoOut = map(q4Out,-1000,1000,0,4095);

//  Serial.print("Q1 (");
//  Serial.print(q1ServoOut);
//  Serial.print(");  Q2(");
//  Serial.print(q2ServoOut);
//  Serial.print(");  Q3(");
//  Serial.print(q3ServoOut);
//  Serial.print(");  Q4(");
//  Serial.print(q4ServoOut);
//  Serial.print("); ");
//  Serial.println(" ");
...
void setSpd(int vel) {
    //Avoid shoot-through
    pwm.setPWM(leftForwardPin,0,0);
    pwm.setPWM(leftReversePin,0,0);
    pwm.setPWM(rightForwardPin,0,0);
    pwm.setPWM(rightReversePin,0,0);
    ...
    if (vel == 0) {
      ...
      pwm.setPWM(leftForwardPin,0,vel);
      pwm.setPWM(leftReversePin,0,0);
      pwm.setPWM(rightForwardPin,0,vel);
      pwm.setPWM(rightReversePin,0,0);
      Serial.print(" LF: ");
      Serial.print(vel);
      Serial.print(" LR: ");
      ...
      pwm.setPWM(leftForwardPin,0,0);
      pwm.setPWM(leftReversePin,0,abs(vel));
      pwm.setPWM(rightForwardPin,0,0);
      pwm.setPWM(rightReversePin,0,abs(vel));
      Serial.print(" LF: ");
      Serial.print(0);
      Serial.print(" LR: ");
      ...
      pwm.setPWM(rightForwardPin,0,0);
      pwm.setPWM(rightReversePin,0,0);
      Serial.print("Error: Speed command is out of bounds. Speed set to: ");
      Serial.println(vel);
      Serial.print(" LF: ");
      Serial.print(0);
      Serial.print(" LR: ");
