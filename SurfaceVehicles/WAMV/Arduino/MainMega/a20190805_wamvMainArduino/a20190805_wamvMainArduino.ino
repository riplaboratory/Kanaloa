...
const byte leftForwardPin = 4;
const byte leftReversePin = 5;
const byte rightForwardPin = 6;
const byte rightReversePin = 7;
...
typedef enum{NONE, GOT_FORWARD, GOT_REVERSE} states;
states state = NONE;
unsigned int currentSerialValue;
int serialSpeedCommand;
int pwmSpeedCommand;
