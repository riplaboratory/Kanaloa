...
//int Q1DacOut = 0;                   // bit output to Q1 DAC
//int Q2DacOut = 0;                   // bit output to Q2 DAC
//int Q3DacOut = 0;                   // bit output to Q3 DAC
//int Q4DacOut = 0;                   // bit output to Q4 DAC
...
void loop() {
  ...
  if (ch7Raw > (pulseMin - 100) && ch7Raw < (pulseMin + 100)) {   // switch is in the UP position
