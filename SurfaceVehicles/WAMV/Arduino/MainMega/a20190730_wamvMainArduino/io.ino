...
//  Serial.println(");");
  ...
  int q1ServoOut = map(q1Out,-1000,1000,0,4096);
  int q2ServoOut = map(q2Out,-1000,1000,0,4096);
  int q3ServoOut = map(q3Out,-1000,1000,0,4096);
  int q4ServoOut = map(q4Out,-1000,1000,0,4096);

  // Output to thrusters
  const int servoRes = 4095;
