...
const int accLimit = 25;          // acceleration limit (maximum change in thrust percentage per second) [%/s]
...
float voltMult = 0.85;      // voltage multiplier to scale output to thrusters (based on battery voltage)
