...
#include "Adafruit_PWMServoDriver.h"    // Adafruit servo shield inclusions
...
const int ch1PulseMin = 1176;     // minimum expected pulse width of ch1 [us]
const int ch1PulseMax = 2176;     // maximum expected pulse width of ch1 [us]
const int ch4PulseMin = 1176;     // minimum expected pulse width of ch4 [us]
const int ch4PulseMax = 2176;     // maximum expected pulse width of ch4 [us]
const int ch6PulseMin = 1240;     // minimum expected pulse width of ch6 [us]
const int ch6PulseMax = 2240;     // maximum expected pulse width of ch6 [us]
