...
const byte ch5Pin = 2;         // PWM in from remote control receiver channel 5 (switches between manual and autonomous mode)
...
const byte statePin = 12;        // digital out to kill-switch Arduino in high current box (HIGH for manual, LOW for autonomous)
...
//  if (ch1PulseWidth > 750 && ch1PulseWidth < 2250) {
//    Serial.println(ch1PulseWidth);
//  }
