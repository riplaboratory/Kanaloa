...
const byte q1KillPin = 26;          // digital out to q1 motor controller kill relay
const byte q2KillPin = 27;          // digital out to q2 motor controller kill relay
const byte q3KillPin = 28;          // digital out to q3 motor controller kill relay
const byte q4KillPin = 29;          // digital out to q4 motor controller kill relay
...
const int ch5PulseMin = 1052;     // minimum expected pulse width of ch5 [us]
const int ch5PulseMax = 2052;     // maximum expected pulse width of ch5 [us]
const int ch7PulseMin = 1032;     // minimum expected pulse width of ch7 [us]
const int ch7PulseMax = 2012;     // maximum expected pulse width of ch7 [us]
const int ch8PulseMin = 1032;     // minimum expected pulse width of ch8 [us]
const int ch8PulseMax = 2032;     // maximum expected pulse width of ch8 [us]
