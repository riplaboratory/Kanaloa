%=========================================================
%
% Stationkeeping and Waypoint Navigation Code 2018.01.17
...
goal_vars = [GPSData.RelPosition.X, GPSData.RelPosition.Y, 0];
...
%     [yaw, pitch, roll] = quat2angle(quat);
    ...
    if(true == Stationkeeping && (0 < WaypointSeekingThreshold) && (WaypointSeekingThreshold < distance_to_target))
        Stationkeeping = false;
        kP = 12.0;
        kI = 0.0;
        kD = 0.0;        
    ...
    fprintf('\n');
    fprintf('Goal Heading: %f radians, %f degrees, X: %f Y: %f\n\n\n', goal_Angle, goal_Angle * 180 / pi, cos(goal_Angle), sin(goal_Angle));
